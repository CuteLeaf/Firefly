...
```
下载完成：
![克隆下载完成](https://cdn.jsdelivr.net/gh/Yutong2333/imges-bed/astro-firefly-push3.avif)
2.安装依赖
```bash
pnpm install
```
...
```
Git上选择关联github帐号：
![选择关联](https://cdn.jsdelivr.net/gh/Yutong2333/imges-bed/astro-firefly-push6.avif)
推送成功界面：
![推送成功了](https://cdn.jsdelivr.net/gh/Yutong2333/imges-bed/Astro-firefly-push7.avif)
