...
export const site = {
  ...
  desc: "梦到啥写啥",
  url: "https://khbit.cn",
  avatar: "https://cravatar.cn/avatar/c0c67928420f1ca7567ad555aeb50ed6",
...
export const notes = [
  ...
  { title: "站点要求", content: "支持 HTTPS，以原创内容为主，能够正常访问" },
];
  ...
  <div class="mt-4 rounded-2xl border border-(--line-divider) overflow-hidden">
    <div class="p-5 sm:p-6">
      ...
      <div class="space-y-3 text-sm text-neutral-600 dark:text-neutral-400">
        ...
        <p><del>但我说实话没什么特别的要求，基本上看着像博客就行。你要真的被我拒绝了你也挺厉害的。</del></p>
      </div>
