...
export const site = {
  ...
  avatar: "https://cdn.jsdelivr.net/gh/xyxnb123/study/xyx.png",
  email: "yuxinxiao2025@163.com",
};
        ...
        <div class="space-y-2.5 flex-1">
          {[
            ...
            <div class="flex items-center justify-between gap-2 rounded-lg bg-black/5 dark:bg-white/5 px-3 py-2">
              ...
              <button 
                onclick={`navigator.clipboard.writeText(\`${item.value}\`);this.querySelectorAll('svg')[0].classList.add('hidden');this.querySelectorAll('svg')[1].classList.remove('hidden');setTimeout(()=>{this.querySelectorAll('svg')[0].classList.remove('hidden');this.querySelectorAll('svg')[1].classList.add('hidden')},1500)`} 
